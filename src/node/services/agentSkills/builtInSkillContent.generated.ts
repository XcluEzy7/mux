...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/agents/custom-agents.mdx": [
      "---",
      "title: Custom Agents",
    ...
    "references/docs/agents/orchestration.mdx": [
      "---",
    ...
    "references/docs/config/tailscale-ssh.mdx": [
      "---",
      "title: Tailscale SSH",
    ...
    "references/docs/docs.json": [
      ...
      '              "reference/codebase-cleanup-plan",',
      '              "reference/future-build-improvements",',
      '              "AGENTS"',
      "            ]",
      "          }",
      "        ]",
    ...
    "references/docs/reference/codebase-cleanup-plan.mdx": [
      "---",
    ...
    "references/docs/reference/future-build-improvements.mdx": [
      "---",
