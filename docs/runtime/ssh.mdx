...
If you're connecting to SSH workspaces via Tailscale, see the [Tailscale SSH documentation](/config/tailscale-ssh) for setup instructions and deep link support.
