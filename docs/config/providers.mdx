...
| **Synthetic**      | Anthropic, OpenAI, Google, xAI, DeepSeek | [synthetic.new](https://synthetic.new/)                 |
...
| ollama-cloud   | `OLLAMA_CLOUD_API_KEY` or `OLLAMA_API_KEY`         |
...
| synthetic-new | `SYNTHETIC_NEW_BASE_URL`   | Custom API endpoint |
| ollama-cloud  | `OLLAMA_CLOUD_BASE_URL`    | Custom API endpoint |
